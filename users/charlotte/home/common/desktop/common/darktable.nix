{ config, pkgs, ... }:
let
  dbLocation = "${config.xdg.userDirs.pictures}/.darktable/library.db";
  darktableLocation = "${config.home.homeDirectory}/.config/darktable";
...
in
{
  ...
  home.file."${darktableLocation}/darktablerc" = {
    ...
    text = ''
      ...
      plugins/darkroom/lut3d/def_path=${darktableLocation}/luts/
  ...
  home.file."${darktableLocation}/shortcutsrc" = {
    force = true;
    text = ''
