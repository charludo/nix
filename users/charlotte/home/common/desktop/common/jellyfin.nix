{ pkgs, ... }:
{
  home.packages = [ pkgs.jellyfin-media-player pkgs.mpd-mpris ];
  ...
  home.file.".local/share/jellyfinmediaplayer/scripts/mpris.so".source = "${pkgs.mpvScripts.mpris}/share/mpv/scripts/mpris.so";
