...
in
{
  ...
  config =
    let
      ...
      ttcHome = "${config.home.homeDirectory}/.steam/steam/steamapps/compatdata/306129/pfx/drive_c/users/steamuser/Documents/Elder Scrolls Online/live/AddOns/TamrielTradeCentre";
